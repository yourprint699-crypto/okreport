...
const Navbar = () => {
    ...
    return (
        <div className='z-50 flex fixed top-0 w-full items-start justify-between px-2 sm:px-3 md:px-4 lg:px-5 py-2 sm:py-3 lg:py-5'>
            ...
            <div onClick={()=>{
                ...
                className='touch-target h-12 sm:h-14 md:h-15 lg:h-16 bg-black relative w-32 sm:w-36 md:w-40 lg:w-[16vw] cursor-pointer active:scale-95 transition-transform duration-150'>
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'></div>
                <div className='relative h-full px-4 sm:px-6 md:px-8 lg:px-12 flex flex-col justify-center items-end gap-1 lg:gap-1.5'>
